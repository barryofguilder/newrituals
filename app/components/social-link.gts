...
export default class SocialLinkComponent extends Component {
  icons = [
    {
      id: 'apple',
      name: 'Apple Music',
  ...
  get icon() {
    return this.icons.find((i) => i.id === this.args.icon);
  }
  ...
  <template>
    ...
    >
      ...
      {{else if (iconEquals this.icon.id "bandcamp")}}
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 640 640"
          class="h-6 w-6 fill-current"
      ...
      {{else if (iconEquals this.icon.id "facebook")}}
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 512 512"
          class="h-6 w-6 fill-current"
      ...
      {{else if (iconEquals this.icon.id "instagram")}}
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 448 512"
          class="h-6 w-6 fill-current"
      ...
      {{else if (iconEquals this.icon.id "spotify")}}
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 496 512"
          class="h-6 w-6 fill-current"
      ...
      {{else if (iconEquals this.icon.id "twitter")}}
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 512 512"
          class="h-6 w-6 fill-current"
      ...
      {{else if (iconEquals this.icon.id "youtube")}}
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 576 512"
          class="h-6 w-6 fill-current"
      ...
      <span class="sr-only">{{this.icon.name}}</span>
    </a>
  </template>
}
